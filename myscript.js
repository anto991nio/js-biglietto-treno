...
if(Number.isNaN (etaPasseggero) || Number.isNaN(kmPercorsi)){
    ...
    document.getElementById("Biglietto").innerHTML = "Il costo del biglietto è "+ "" + (prezzoBiglietto - prezzoBiglietto * 0.20 ).toFixed(2) ;
    } 


    else if (etaPasseggero > 65) {
    console.log( prezzoBiglietto - prezzoBiglietto * 0.40 )
    document.getElementById("Biglietto").innerHTML = "Il costo del biglietto è "+ "" + (prezzoBiglietto - prezzoBiglietto * 0.40 ).toFixed(2) ;
    }

    else{
    console.log(prezzoBiglietto);
    document.getElementById("Biglietto").innerHTML = "Il costo del biglietto è "+ "" + prezzoBiglietto.toFixed(2) ;
    }
}
